import { GET_PAGES, GET_APP, VIEW_NAV, VIEW_BODY, VIEW_TYPES, VIEW_SHOWMODAL, VIEW_MODALCONTENT, VIEW_MENU, VIEW_VIDEO, VIEW_THANKS, VIEW_TABS, VIEW_TABS1, VIEW_EVENT, LOADING } from './mutation-types.js'
