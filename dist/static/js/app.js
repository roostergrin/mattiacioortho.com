...
var _veeValidate = __webpack_require__(592);
...
var _vueScrollto = __webpack_require__(741);

var _vueScrollto2 = _interopRequireDefault(_vueScrollto);

var _vueWaypoint = __webpack_require__(743);
...
var _vueRouter = __webpack_require__(740);
...
var _contactUs = __webpack_require__(646);

var _contactUs2 = _interopRequireDefault(_contactUs);

var _home = __webpack_require__(650);

var _home2 = _interopRequireDefault(_home);

var _invisalign = __webpack_require__(651);
...
var _mattiacioDifference = __webpack_require__(652);

var _mattiacioDifference2 = _interopRequireDefault(_mattiacioDifference);

var _newPatients = __webpack_require__(654);

var _newPatients2 = _interopRequireDefault(_newPatients);

var _virtualServices = __webpack_require__(663);

var _virtualServices2 = _interopRequireDefault(_virtualServices);

var _virtualConsultation = __webpack_require__(662);

var _virtualConsultation2 = _interopRequireDefault(_virtualConsultation);

var _videos = __webpack_require__(661);

var _videos2 = _interopRequireDefault(_videos);

var _andUp = __webpack_require__(642);

var _andUp2 = _interopRequireDefault(_andUp);

var _treatments = __webpack_require__(660);

var _treatments2 = _interopRequireDefault(_treatments);

var _familyFunEvent = __webpack_require__(648);

var _familyFunEvent2 = _interopRequireDefault(_familyFunEvent);

var _thankYou = __webpack_require__(659);

var _thankYou2 = _interopRequireDefault(_thankYou);

var _mouthGuardThankYou = __webpack_require__(653);

var _mouthGuardThankYou2 = _interopRequireDefault(_mouthGuardThankYou);

var _exitInterview = __webpack_require__(647);

var _exitInterview2 = _interopRequireDefault(_exitInterview);

var _smileAssuranceProgram = __webpack_require__(657);

var _smileAssuranceProgram2 = _interopRequireDefault(_smileAssuranceProgram);

var _retainerProgram = __webpack_require__(655);

var _retainerProgram2 = _interopRequireDefault(_retainerProgram);

var _accessibility = __webpack_require__(644);

var _accessibility2 = _interopRequireDefault(_accessibility);

var _review = __webpack_require__(656);

var _review2 = _interopRequireDefault(_review);

var _adminLinks = __webpack_require__(645);

var _adminLinks2 = _interopRequireDefault(_adminLinks);

var _styleGuide = __webpack_require__(658);
...
var router = new _vueRouter2.default({
  ...
  routes: [{
    ...
    name: 'Admin Links',
    navigation: false,
    component: _adminLinks2.default,
    meta: {
      auth: true
    }
  }, {
...
var _extends4 = __webpack_require__(300);
...
var _vuex = __webpack_require__(744);

var _vuex2 = _interopRequireDefault(_vuex);

var _mutations = __webpack_require__(218);
...
var _eventModal = __webpack_require__(635);

var _eventModal2 = _interopRequireDefault(_eventModal);

var _footer = __webpack_require__(625);
...
var _modal = __webpack_require__(637);

var _modal2 = _interopRequireDefault(_modal);

var _navigation = __webpack_require__(641);

var _navigation2 = _interopRequireDefault(_navigation);

var _modalThanks = __webpack_require__(636);
...
var _sponsorForm = __webpack_require__(629);
...
var _videoModal = __webpack_require__(638);
  ...
  methods: {
    ...
    onSubmit: function () {
      var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee() {
        ...
        var trackingData, referrerSource, utmSource, campaign, baseUrl, response;
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return _axios2.default.post(this.postUrl, {
                  fullname: this.fullname,
                  phone: this.phone,
                  email: this.email,
              ...
              case 4:
                _context.prev = 4;
                trackingData = JSON.parse(sessionStorage.getItem('sessionTrackingData')) ? JSON.parse(sessionStorage.getItem('sessionTrackingData')).trackingParams : undefined;
                referrerSource = trackingData ? trackingData.referrerSource : undefined;
                utmSource = trackingData ? trackingData.source : undefined;
                campaign = trackingData ? trackingData.campaign : undefined;
                baseUrl = 'https://api.threadcommunication.com';
                _context.next = 12;
                return _axios2.default.post(baseUrl + '/api/v1/website_leads', {
              ...
              case 16:
                ...
                console.error('New Lead not created in RG CRM.', _context.t0);
...
var _heroMobile = __webpack_require__(631);

var _heroMobile2 = _interopRequireDefault(_heroMobile);

var _homeHero = __webpack_require__(633);

var _homeHero2 = _interopRequireDefault(_homeHero);

var _heroPages = __webpack_require__(632);
...
exports.default = {
  ...
  computed: {
    svg: function svg() {
      return __webpack_require__(745)("./" + this.name + '.svg');
    }
  }
};
...
var _familyFunForm = __webpack_require__(627);
...
var _customPlatinum = __webpack_require__(616);
  ...
  methods: {
    toggleMenu: function toggleMenu() {
      ...
      if (menuClosed && !this.$store.state.nav) {
        ...
        document.body.classList.add('body-stop');
        if (document.getElementsByClassName('header--review').length > 0) {
          document.getElementsByClassName('header--review')[0].classList.add('menuaddreview');
        }
      }
      if (menuClosed && !this.$store.state.nav) {
        this.$store.dispatch('VIEW_MENU', true);
...
var _navDesktop = __webpack_require__(639);

var _navDesktop2 = _interopRequireDefault(_navDesktop);

var _navMobile = __webpack_require__(640);
...
var _customTreatments7up = __webpack_require__(617);
...
var _customThankYou = __webpack_require__(193);
...
exports.default = {
  ...
  computed: {
    props: function props() {
      return this.$store.state.pages['admin-links'];
    },
    loading: function loading() {
      return this.$store.state.loading;
    }
...
var _customContactFormSection = __webpack_require__(601);
...
var _customContactHeader = __webpack_require__(602);
...
var _customContactSponsorSection = __webpack_require__(603);
...
var _exitInterviewForm = __webpack_require__(626);
...
var _vueConfetti = __webpack_require__(594);
...
exports.default = {
  ...
  watch: {
    'props.acf.wpass': function propsAcfWpass(newValue) {
...
exports.default = {
  ...
  computed: {
    props: function props() {
      return this.$store.state.pages['feedback'];
    },
    loading: function loading() {
      return this.$store.state.loading;
    }
...
var _customInvisalignSections = __webpack_require__(609);
...
var _customMattiacioWhat = __webpack_require__(610);
...
var _customMouthGuardThankYou = __webpack_require__(611);
...
var _customNewPatsFinancial = __webpack_require__(612);

var _customNewPatsFinancial2 = _interopRequireDefault(_customNewPatsFinancial);

var _customNewPatsFirst = __webpack_require__(613);
...
var _customNewPatsPatients = __webpack_require__(615);

var _customNewPatsPatients2 = _interopRequireDefault(_customNewPatsPatients);

var _customNewPatsPatientsOne = __webpack_require__(614);
...
var _smileAssuranceForm = __webpack_require__(628);
...
var _customTreatmentsAdults = __webpack_require__(618);

var _customTreatmentsAdults2 = _interopRequireDefault(_customTreatmentsAdults);

var _customTreatmentsDamon = __webpack_require__(619);
...
var _customTreatmentsInvisalign = __webpack_require__(620);
...
var _customVideos = __webpack_require__(621);
...
var _customVirtualConsultationBanner = __webpack_require__(622);

var _customVirtualConsultationBanner2 = _interopRequireDefault(_customVirtualConsultationBanner);

var _customVirtualConsultationHow = __webpack_require__(623);
...
var _customVirtualServices = __webpack_require__(624);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("Powered by RoosterGrin"), _c('div', {
    staticClass: "footer__adminuse"
  }, [_c('router-link', {
    attrs: {
      "to": "/admin-links"
    }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "pages-review"
  }, [_c('div', {
    staticClass: "pages-review__wrap"
  }, [(_vm.props.acf.title) ? _c('h2', {
    staticClass: "pages-review__title",
    domProps: {
      "innerHTML": _vm._s(_vm.props.acf.title)
    }
  }) : _vm._e(), (_vm.props.acf.content) ? _c('p', {
    staticClass: "pages-review__text",
    domProps: {
      "innerHTML": _vm._s(_vm.props.acf.content)
    }
  }) : _vm._e(), (_vm.props.acf.scan_image) ? _c('img', {
    staticClass: "pages-review__scan",
    attrs: {
      "src": _vm.props.acf.scan_image,
      "alt": "Scan image"
    }
  }) : _vm._e(), _c('a', {
    staticClass: "pages-review__link",
    attrs: {
      "href": "/smile-assurance-program?skip=1",
      "title": "next"
    }
  }, [_vm._v("Next")]), _c('p', {
    staticClass: "pages-review__text",
  ...
  }, [_vm._v(" Once on Google, under Mattiacio Orthodontics, click on the \"Reviews\" tab. Scroll down to \"Rate and Review on Google\" and select your star rating and leave us a review!")])])])
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return (_vm.props) ? _c('div', {
    staticClass: "header",
    class: {
      'header--home': _vm.$route.path === '/' && !_vm.$store.state.menu, 'header--family-fun-event': _vm.$route.path.includes('/mouth-guard-registration'), 'header--retainer-program': _vm.$route.path.includes('/retainer-program'), 'header--exit-interview': _vm.$route.path.includes('/exit-interview'), 'header--smile-assurance': _vm.$route.path.includes('/smile-assurance-program'), 'header--thank-you': _vm.$route.path.includes('/thank-you'), 'header--adminlink': _vm.$route.path.includes('/admin-links'), 'header--review': _vm.$route.path.includes('/review') || _vm.$route.path.includes('/accessibility') || _vm.$route.path.includes('/mouth-guard-thank-you')
    },
    attrs: {
      "id": "head"
    }
    ...
    class: {
      'header__menu--thank-you': _vm.$route.path.includes('/thank-you'), 'header__menu--adminlink': _vm.$route.path.includes('/admin-links'), 'header__menu--exit-interview': _vm.$route.path.includes('/exit-interview'), 'header__menu--review': _vm.$route.path.includes('/review'), 'header__menu--smile-assurance': _vm.$route.path.includes('/smile-assurance-program'), 'header__menu--retainer-program': _vm.$route.path.includes('/retainer-program') || _vm.$route.path.includes('/mouth-guard-thank-you') || _vm.$route.path.includes('/accessibility')
    }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "pages-adminlinks"
  }, [_c('div', {
    staticClass: "pages-adminlinks__content"
  }, [(_vm.props.acf.page_title) ? _c('h2', {
    staticClass: "pages-adminlinks__title",
    domProps: {
      "innerHTML": _vm._s(_vm.props.acf.page_title)
    }
  }) : _vm._e(), _c('div', {
    staticClass: "pages-adminlinks__list"
  }, _vm._l((_vm.props.acf.page_links_lists), function(lists, i) {
    return _c('div', {
      staticClass: "pages-adminlinks__listitem"
    }, [_c('router-link', {
      attrs: {
        "to": lists.links
      },
      domProps: {
        "innerHTML": _vm._s("https://www.mattiacioortho.com" + lists.links)
      }
    })], 1)
  }), 0)])])
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    domProps: {
      "innerHTML": _vm._s(_vm.props.acf.custom_thank_you.content)
    }
  })])])])])
},staticRenderFns: []}
...
var map = {
	...
	"./goog.svg": 563,
	"./graduation.svg": 564,
	"./hand-sparkles.svg": 565,
	"./head-side-mask.svg": 566,
	"./helmet.svg": 567,
	"./ig.svg": 568,
	"./insurance.svg": 569,
	"./invisalign-teen.svg": 570,
	"./invisalign.svg": 571,
	"./kite.svg": 572,
	"./location.svg": 573,
	"./lungs.svg": 574,
	"./mask.svg": 575,
	"./matt_logo-01.svg": 576,
	"./matt_logo_small.svg": 577,
	"./mobile-alt.svg": 578,
	"./party.svg": 579,
	"./people-arrows.svg": 580,
	"./personal.svg": 581,
	"./phone.svg": 582,
	"./ribbon.svg": 583,
	"./shield.svg": 584,
